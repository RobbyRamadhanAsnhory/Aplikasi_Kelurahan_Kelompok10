...
class _LoginPageState extends State<LoginPage> {
  ...
  var nama_lengkap = TextEditingController();
  ...
  Column buildSignInTextFieldSection() {
    return Column(
      children: [
        buildTextField("EMAIL", "Masukan Email", false, emailsignin),
        SizedBox(
          height: 30,
        ),
        buildTextField("PASSWORD", "Masukan Password", true, passwordsignin),
      ],
    );
  }
  ...
  Column buildSignUpTextFieldSection() {
    return Column(
      children: [
        buildTextField("NAMA LENGKAP", "Masukan Nama", false, nama_lengkap),
        SizedBox(
          height: 20,
        ),
        buildTextField("EMAIL", "Masukan Email", false, emailsignup),
        SizedBox(
          height: 20,
        ),
        buildTextField("NIK", "Masukan Nik", false, nik),
        SizedBox(
          height: 20,
        ),
        buildTextField("PASSWORD", "Masukan Password", true, passwordsignup),
      ],
    );
  }
